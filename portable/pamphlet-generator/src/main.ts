...
function updateMobileViewScale(): void {
    if (viewMode !== "mobile") {
        main.style.setProperty("--mobile-view-scale", "1");
    ...
    requestAnimationFrame(() => {
        const unscaledWidth = main.scrollWidth;
        const unscaledHeight = main.scrollHeight;
...
function setViewMode(mode: ViewMode): void {
    viewMode = mode;
    main.classList.toggle("pamphlet-view--mobile", mode === "mobile");
    main.classList.toggle("pamphlet-view--desktop", mode === "desktop");
